    ...
    return (
        <div className='pb-5'>
            <div className='text-center pt-8 pb-24 max-w-3xl mx-auto'>
                <h3 className='text-5xl font-semibold px-2.5 pb-8'>Get to know us better!</h3>
            ...
            <div className='pb-7 pt-10 px-10 flex'>
                <div>
                ...
                <div className='pt-4 grow'>
                    <Link to="/" className='text-base py-1 px-2 ms-3'>Work</Link>
                    <Link to="/" className='text-base py-1 px-2 ms-3'>Technologies</Link>
                    <Link to="/" className='text-base py-1 px-2 ms-3'>Services</Link>
                    <Link to="/" className='text-base py-1 px-2 ms-3'>Company</Link>
                    <Link to="/" className='text-base py-1 px-2 ms-3'>Contacts</Link>
                    <div className='flex'>
                    <Link to="/" className='text-base py-1 px-2 ms-3'>Terms and Conditions</Link>
                    <Link to="/" className='text-base py-1 px-2 ms-3'> Privacy Policy</Link>
                    </div>
                </div>
                <div>
