...
const Fintech = () => {
    ...
    return (
        <div style={{ backgroundColor: 'rgba(63, 44, 170, 0.9)',  }} className='h-fit md:flex md:px-10 md:py-36 px-3 pt-6 pb-8'>
            ...
            <div className='md:w-1/2 px-3 pt-5 md:pt-0 md:mx-14' >
                ...
                <div className='grid grid-cols-2 md:flex md:gap-2 gap-1  pb-8'>
                    <p style={{ backgroundColor: 'rgba(255, 255, 255, 0.11)',  }} className='text-sm px-3 py-1.5 rounded-full text-center'>Fraud detection</p>
                    <p style={{ backgroundColor: 'rgba(255, 255, 255, 0.11)',  }} className='text-sm px-3 py-1.5 rounded-full text-center'>Transaction categorisation</p>
                    <p style={{ backgroundColor: 'rgba(255, 255, 255, 0.11)',  }} className='text-sm px-3 py-1.5 rounded-full text-center'>Risk Scoring</p>
                </div>
