    ...
    return (
        <div className='bg-black pt-16 pb-36'>
            ...
            <div className='max-w-3xl mx-auto bg-black text-center'>
                ...
                <p className='text-xl px-10 pb-14'>Our case studies describe design and development solutions implemented at our Geeks Invention projects. The stories are a valuable resource for those looking to develop their own mobile apps.</p>
